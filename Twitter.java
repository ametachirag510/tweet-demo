 ...
 *                    employee. if user1 post tweets having tweets id 1 will not allocate two other user's tweet.
 * 
 * 4.postTweet()  -  will post Tweet for Given User Id
 * 
 * 5 getNewsFeed() - get recent 10 tweets (tweets include own tweets and followees tweets in case if user followed to others)
 * 
 * 6. follow() -     if user follow to other user, other users to whom current user will follow,their tweets will be in its recent tweets
 * 
 * 7. unfollow() -   if user unfollow to other like user2,  then  user2's tweet will not  be in current user's recent tweets
 */
